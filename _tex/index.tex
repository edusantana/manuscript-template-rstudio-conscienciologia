...
\urlstyle{same}
\hypersetup{
  pdftitle={Autogestão do voluntariado conscienciológico: Relatório de 2025},
  pdfauthor={Eduardo Santana},
  pdflang={pt-BR},
  pdfkeywords={Voluntariado, Conscienciologia, Autogestão},
  colorlinks=true,
  linkcolor={blue},
  filecolor={Maroon},
  citecolor={Blue},
...
\begin{document}
\title{Autogestão do voluntariado conscienciológico: Relatório de 2025}

\authors{Eduardo Santana\affil{1,2,3}}
\affiliation{1}{ISIC, }\affiliation{2}{Editares, }\affiliation{3}{Juriscons, }
\correspondingauthor{Eduardo Santana}{eduardo@editares.org}


\begin{abstract}
This is a draft of template document to be used for conscienciology
publications. It's in alpha stage.
\end{abstract}

\section*{Plain Language Summary}
Esse documento apresenta um modelo para utilização em autopesquisa na
conscienciologia.
...
\textsubscript{Fonte:
\href{https://edusantana.github.io/manuscript-template-rstudio-conscienciologia/index.qmd.html}{Caderno
de Artigo}}
...
Data and methods are discussed in Seção~\ref{sec-data-methods}.
...
Equação~\ref{eq-poisson}, the probability of an eruption in the next
...
Tabela~\ref{tbl-history} summarises the eruptions recorded since the
...
the Canary Islands (Figura~\ref{fig-map}).
...
\textsubscript{Fonte:
\href{https://edusantana.github.io/manuscript-template-rstudio-conscienciologia/notebooks/explore-earthquakes-preview.html\#cell-fig-spatial-plot}{Explore
Earthquakes}}

Figura~\ref{fig-spatial-plot} shows the location of recent Earthquakes
on La Palma.
