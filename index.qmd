...
keywords:
  ...
  - Autogestão
abstract: |
  This is a draft of template document to be used for conscienciology publications. It's in alpha stage.
plain-language-summary: |
  Esse documento apresenta um modelo para utilização em autopesquisa na conscienciologia.
key-points:
  - Configuração no github para publicação no github.io
  - Arquivos de modelos
date: last-modified
